...
export class OrderController {
    ...
    @UseGuards(AuthGuard('jwt'))
    @Patch('update-order-line/:orderLineId')
    async updateOrderLine(@Param('orderLineId') orderLineId: string,@Body() updateOrderLineDto: UpdateOrderLineDto) {
    return this.orderService.updateOrderLine(+orderLineId, updateOrderLineDto);
    }
